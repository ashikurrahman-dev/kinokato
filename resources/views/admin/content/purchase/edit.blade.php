                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4 row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-2 form-group row">
                                        <label for="fname" class="text-right col-sm-4 control-label col-form-label">Transport</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="mb-2 form-group row paymentAmount">
                                        <label for="fname" class="text-right col-sm-4 control-label col-form-label">Payment Amount</label>
                                        <div class="col-sm-8">
                            ...
                            <table id="productTable" style="width: 100% !important;" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($purchase->products as $product)
                                        ...
                                        <td><input type="text" name="productPrice" id="productPrice" value="{{$product->product_price}}" style="    max-width: 80px;" ></td>
