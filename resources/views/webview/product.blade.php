    ...
    <div class="row">
        <div class="col-12">
            <div class="section-title">
                <div class="title-top">
                    <span class="bar"></span>
                    <span class="category-text">Category Products</span>
                </div>
                <div style="display:flex; align-items:center; justify-content: space-between;margin:20px 0">
                    <h2 class="m-0 main-title">{{ $categorysingle->category_name }} Products</h2>
                                            ...
                                            <div class="text-center image">
                                                ...
                                                <div class="wishlist-eye-btn">
                                                    ...
                                                    <button class="quick-shop-btn" type="button"
                                                        ...
                                                        <i class="fa-regular fa-eye" style="font-size: 18px;color:black;"></i>
                                                    </button>
                                                </div>
