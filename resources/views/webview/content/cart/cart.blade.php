...
<section class="slice-xs sct-color-2 border-bottom">
    <div class="container container-sm">
        <div class="row d-flex justify-content-center">
            <div class="col">
                <div class="text-center icon-block icon-block--style-1-v5 active">
                    <div class="mb-0 block-icon">
                        <i style="font-size: 34px;color: #120d3f" class="fas fa-shopping-cart" aria-hidden="true"></i>
                    </div>
            ...
            <div class="col">
                <div class="text-center icon-block icon-block--style-1-v5">
                    <div class="mb-0 block-icon c-gray-light">
